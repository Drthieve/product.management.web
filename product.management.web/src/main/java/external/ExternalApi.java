...
public class ExternalApi {
     ...
     */
    @GET
    public Response getMovieByTitleWithExternalAPI(@QueryParam("id") String title) {
        Client client = ClientBuilder.newClient();
        if(title == null || title.trim().isEmpty()) {
            title = "simple";
        }
        String url = "https://asos2.p.rapidapi.com/v2/auto-complete/titles/search/keyword/"+ title+"?limit=50";
        ...
        String rs = target.request(MediaType.APPLICATION_JSON_TYPE)
                ...
                .header("X-RapidAPI-Host", "web.p.rapidapi.com")
                .get(String.class);
